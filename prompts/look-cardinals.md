Create one horizontal four-cardinal anchor strip for Codex pet `coder-usagi`.

Use the attached canonical base, completed standard contact sheet, and layout guide for exact identity, style, scale, baseline, face construction, materials, palette, markings, props, and spacing. Read `prompts/look-mechanics.md` and use the pet's natural gaze mechanism.
